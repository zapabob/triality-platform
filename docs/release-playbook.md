...
- fixture export succeeds for both supported modes
...
- the current upstream smoke front-end is `llama-completion`; `llama-cli` remains built but is not the release acceptance path
